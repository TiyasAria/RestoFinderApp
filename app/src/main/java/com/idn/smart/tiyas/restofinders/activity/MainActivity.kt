...
import com.idn.smart.tiyas.restofinders.adapter.MainAdapter
import com.idn.smart.tiyas.restofinders.adapter.MainAdapterHorizontal
import com.idn.smart.tiyas.restofinders.model.ModelMain
import com.idn.smart.tiyas.restofinders.model.ModelMainHorizontal
import com.idn.smart.tiyas.restofinders.networking.ApiEndpoint
import com.idn.smart.tiyas.restofinders.utils.OnItemClickCallback
...
class MainActivity : AppCompatActivity(), LocationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchResto.queryHint = "Cari Restoran"
    ...
    private fun showRecyclerResto() {
        ...
        rvCollection.adapter = mainAdapterHorizontal
    ...
    private fun setSearchResto(query: String) {
        ...
        AndroidNetworking.get(ApiEndpoint.BASEURL + ApiEndpoint.CariResto + query + "&lat=" + lat + "&lon=" + lng + "&radius=20000")
                .addHeaders("user-key", "7d22c1608db146ea268d8a685a4e298a")
